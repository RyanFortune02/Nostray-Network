        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="col-span-1">
            ...
            <p className="text-gray-300 text-sm">
              No Stray Animals Ever is dedicated to rescuing, rehabilitating, and rehoming stray animals. 
              Our mission is to create a world where every animal has a safe and loving home.
            </p>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/volunteer" className="text-gray-300 hover:text-white text-sm">Volunteer</Link></li>
            </ul>
          </div>
