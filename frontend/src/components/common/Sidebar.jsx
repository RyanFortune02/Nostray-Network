import { BarChart2, ChartNoAxesCombined, HelpingHand, Mails, Menu, PawPrint, Settings, Users } from "lucide-react";
...
const SIDEBAR_ITEMS = [
    ...
    { name: "Volunteers", icon: HelpingHand, color: "#EC4899", href: "/volunteers" },
    { name: "Messages", icon: Mails, color: "#10B981", href: "/messages" },
    { name: "HR", icon: Users, color: "#F59E0B", href: "/hr" },
    { name: "Analytics", icon: ChartNoAxesCombined, color: "#3B82F6", href: "/analytics" },
